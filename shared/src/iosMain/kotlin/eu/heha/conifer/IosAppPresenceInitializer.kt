 ...
 * Android, the app is put away when it goes into the background and brought back when it returns.
 *
 * The goodbye therefore means "the last thing this run did was leave the screen". A run whose log
 ...
 */
object IosAppPresenceInitializer : AppPresenceInitializer {
